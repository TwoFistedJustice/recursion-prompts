...
O: an array of numbers
C: arrays must contain only numbers
E: none
What this fn does: It recursively finds groups of zeros and reduces them to a single zero
Relationship btwn inputs and outputs: The output is the input without the consecutive zeros
*/
...
var minimizeZeroes = function(array) {
  if (array.length === 1) {
    ...
    return output.concat(minimizeZeroes(array.slice(1, array.length)));
  }
};
...
/*
I: a string, and a dom node
O: a number
C: tag must be an html element type
E: none
What this fn does: It recursively searches the dom for a given tag name and counts the number of times it occurs.
Relationship btwn inputs and outputs: The output is the number of times the tag occurs in the dom.
*/
